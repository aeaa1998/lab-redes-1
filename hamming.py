...
def normalize_text_with_parity_bits(data):
    ...
    number_of_parity_checks = int(math.log2(size))
    # print("Parity", number_of_parity_checks)
...
def hamming_correct(data):
    index_error = reduce(op.xor, [i for i, v in enumerate(data) if int(v)])
    # print("Pos error", index_error)
    if index_error != 0:
...
# print(get01('a'))
# print(16-(32 % 16))
# dictionary, normalized = normalize_text_with_parity_bits("00110001")
# out = ""
